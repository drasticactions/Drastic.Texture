...
namespace Drastic.SDWebImage
{
	static class CFunctions
	{
		...
		// extern NSImage * _Nullable SDScaledImageForKey (NSString * _Nullable key, NSImage * _Nullable image);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDScaledImageForKey ([NullAllowed] NSString key, [NullAllowed] NSImage image);

		// extern NSImage * _Nullable SDScaledImageForScaleFactor (CGFloat scale, NSImage * _Nullable image);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDScaledImageForScaleFactor (nfloat scale, [NullAllowed] NSImage image);

		// extern NSImage * _Nullable SDImageCacheDecodeImageData (NSData * _Nonnull imageData, NSString * _Nonnull cacheKey, SDWebImageOptions options, SDWebImageContext * _Nullable context);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDImageCacheDecodeImageData (NSData imageData, NSString cacheKey, SDWebImageOptions options, [NullAllowed] NSDictionary<NSString, NSObject> context);
		...
		// extern NSImage * _Nullable SDImageLoaderDecodeImageData (NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, SDWebImageOptions options, SDWebImageContext * _Nullable context);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDImageLoaderDecodeImageData (NSData imageData, NSUrl imageURL, SDWebImageOptions options, [NullAllowed] NSDictionary<NSString, NSObject> context);

		// extern NSImage * _Nullable SDImageLoaderDecodeProgressiveImageData (NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, BOOL finished, id<SDWebImageOperation> _Nonnull operation, SDWebImageOptions options, SDWebImageContext * _Nullable context);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDImageLoaderDecodeProgressiveImageData (NSData imageData, NSUrl imageURL, bool finished, SDWebImageOperation operation, SDWebImageOptions options, [NullAllowed] NSDictionary<NSString, NSObject> context);
		...
		// extern NSImage * _Nullable SDGraphicsGetImageFromCurrentImageContext ();
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		[return: NullAllowed]
		static extern NSImage SDGraphicsGetImageFromCurrentImageContext ();
	}
	...
	[Flags]
	[Native]
	public enum SDRectCorner : ulong
	{
		TopLeft = 1uL << 0,
		TopRight = 1uL << 1,
		BottomLeft = 1uL << 2,
	...
	[Flags]
	[Native]
	public enum SDWebImageAnimationOptions : ulong
	{
		AllowsImplicitAnimation = 1uL << 0,
